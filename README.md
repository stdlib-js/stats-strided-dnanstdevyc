...
```bash
npm install @stdlib/stats-strided-dnanstdevyc
```
...
```javascript
var dnanstdevyc = require( '@stdlib/stats-strided-dnanstdevyc' );
```
...
#### stdlib_strided_dnanstdevyc( N, correction, \*X, strideX )
...
double v = stdlib_strided_dnanstdevyc( 4, 1.0, x, 1 );
// returns ~2.0817
```
...
```c
double stdlib_strided_dnanstdevyc( const CBLAS_INT N, const double correction, const double *X, const CBLAS_INT strideX );
```

#### stdlib_strided_dnanstdevyc_ndarray( N, correction, \*X, strideX, offsetX )
...
double v = stdlib_strided_dnanstdevyc_ndarray( 4, 1.0, x, 1, 0 );
// returns ~2.0817
```
...
```c
double stdlib_strided_dnanstdevyc_ndarray( const CBLAS_INT N, const double correction, const double *X, const CBLAS_INT strideX, const CBLAS_INT offsetX );
```
