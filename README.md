...
<!-- <div class="equation" align="center" data-raw-text="\sigma = \sqrt{\frac{1}{N} \sum_{i=0}^{N-1} (x_i - \mu)^2}" data-equation="eq:population_standard_deviation">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@0050bc2c25e356df439a060477de2f6ec72f9fb0/lib/node_modules/@stdlib/stats/strided/dnanstdevyc/docs/img/equation_population_standard_deviation.svg" alt="Equation for the population standard deviation.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="\mu = \frac{1}{N} \sum_{i=0}^{N-1} x_i" data-equation="eq:population_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@0050bc2c25e356df439a060477de2f6ec72f9fb0/lib/node_modules/@stdlib/stats/strided/dnanstdevyc/docs/img/equation_population_mean.svg" alt="Equation for the population mean.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="s = \sqrt{\frac{1}{n-1} \sum_{i=0}^{n-1} (x_i - \bar{x})^2}" data-equation="eq:corrected_sample_standard_deviation">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@0050bc2c25e356df439a060477de2f6ec72f9fb0/lib/node_modules/@stdlib/stats/strided/dnanstdevyc/docs/img/equation_corrected_sample_standard_deviation.svg" alt="Equation for computing a corrected sample standard deviation.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="\bar{x} = \frac{1}{n} \sum_{i=0}^{n-1} x_i" data-equation="eq:sample_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@0050bc2c25e356df439a060477de2f6ec72f9fb0/lib/node_modules/@stdlib/stats/strided/dnanstdevyc/docs/img/equation_sample_mean.svg" alt="Equation for the sample mean.">
    <br>
</div> -->
...
```javascript
dnanstdevyc = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dnanstdevyc@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-dnanstdevyc/tags). For example,

```javascript
dnanstdevyc = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dnanstdevyc@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dnanstdevyc = require( 'path/to/vendor/umd/stats-strided-dnanstdevyc/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dnanstdevyc@umd/browser.js"></script>
```
...
#### dnanstdevyc( N, correction, x, strideX )

Computes the [standard deviation][standard-deviation] of a double-precision floating-point strided array ignoring `NaN` values and using a one-pass algorithm proposed by Youngs and Cramer.
...
var v = dnanstdevyc( 5, 1, x1, 2 );
// returns 2.5
```

#### dnanstdevyc.ndarray( N, correction, x, strideX, offsetX )
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-dnanstdevyc.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-dnanstdevyc

[test-image]: https://github.com/stdlib-js/stats-strided-dnanstdevyc/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-strided-dnanstdevyc/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-dnanstdevyc/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-dnanstdevyc?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-dnanstdevyc.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-dnanstdevyc/main
...
[branches-url]: https://github.com/stdlib-js/stats-strided-dnanstdevyc/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-dnanstdevyc/main/LICENSE
